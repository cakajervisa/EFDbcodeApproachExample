...
namespace EFDbFirstApproachExample.Controllers
{
    ...
    {
        // GET: Products/Index
        public ActionResult Index(string search = "", string SortColumn = "ProductName",
            string IconClass="fa-sort-asc", int PageNo = 1)
        {
            ...
            //    else
            //        products = products.OrderByDescending(temp => brandtemp.Brand.BrandName).ToList();
            //}
